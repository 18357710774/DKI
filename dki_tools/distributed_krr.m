function  [yev_hat, tc] = distributed_krr(xtr, ytr, xev, lambda, KerPara, indjCell, Nr)
...
for k = 1:m
    ...
    tic;
    MD = Ktr_tmp + lambda*Ntr_tmp*eye(Ntr_tmp);
    alpha_tmp = MD\ytr_tmp;
    t_tmp = toc;
